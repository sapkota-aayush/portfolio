    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span style={{ textDecoration: "line-through" }}>static</span>{" "}
            flipped ✓
          </div>
        </div>
        <TapeStrip
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: "var(--fs-script)" }}>ship</div>
        <div style={{ fontSize: "var(--fs-script)" }}>the demo</div>
        <div
          style={{
            position: "absolute",
            top: -8,
...
function TodoList({ ready: _ready }: { ready: boolean }) {
  ...
  const [items, setItems] = useState<{ text: string; done: boolean }[]>([
    { text: "clone journal", done: true },
    { text: "add aayush", done: true },
    { text: "wire projects", done: false },
    { text: "ship demo", done: false },
  ]);
