...
// Order matters — LinkedIn is the preferred first-contact channel, so it
// sits at the top. Email is still available with click-to-copy.
const FIELDS: ContactField[] = [
  {
    label: "linkedin",
    display: "/in/aayush-sapkota",
    href: "https://www.linkedin.com/in/aayush-sapkota/",
    icon: <LinkedInIcon />,
  },
  {
    label: "github",
    display: "/sapkota-aayush",
  ...
  },
  {
    label: "youtube",
    display: "@AayuSapkota",
    href: "https://www.youtube.com/@AayuSapkota",
    icon: <YouTubeIcon />,
  },
  {
    label: "email",
    display: "aayush@aayussh.com",
...
export function ContactPage({
  ...
  const onCopyEmail = async (e: React.MouseEvent) => {
    ...
    try {
      await navigator.clipboard.writeText("aayush@aayussh.com");
      setCopied("email");
      e.preventDefault();
    } catch {
  ...
  return (
    ...
    <div style={{ position: "absolute", inset: 0 }}>
      ...
      >
        ...
        >
          easiest way to reach me is LinkedIn DM. email works too if you like
        ...
        >
          <HandwrittenText text="— aayush" delayMs={SIGNATURE_DELAY} />
        </div>
      </div>

      <PageCorner pageNumber="08" />
    </div>
...
function YouTubeIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" aria-hidden>
      ...
      />
      <path
        d="M 8.2 7.5 L 12.4 10 L 8.2 12.5 Z"
        fill="currentColor"
      />
    </svg>
  );
