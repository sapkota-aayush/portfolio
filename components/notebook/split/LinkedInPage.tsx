...
const POSTS: Post[] = [
  {
    ...
    heroSrc: "/Awards.jpeg",
    caption: "three awards at the 2026 SLC gala",
    rotation: -3,
  },
  {
  ...
  {
    url: "https://www.youtube.com/live/_fb5Xqjcm-U?si=RMwEq9-tGipTapWM&t=780",
    heroSrc: "/Anotthermain.jpeg",
    caption: "Mayor's Innovation Challenge pitch",
    rotation: -2,
  },
  {
    url: "https://voice.aayussh.com/",
    heroSrc: "/vojurlogo.png",
    caption: "Vojur — voice-first journaling",
    rotation: 3,
  },
  {
    url: "https://slcnavigation.aayussh.com/",
    heroSrc: "/Main%20photo.jpeg",
    caption: "building around campus problems",
    rotation: -4,
  },
];
  ...
  return (
    ...
    <div style={{ position: "absolute", inset: 0 }}>
      ...
      >
        ...
        >
          a few favorite builds and moments — click a card to open the link.
        </p>
...
function PostCard({
  ...
  return (
    <a
      ...
      aria-label={`Open highlight: ${post.caption}`}
      onClick={(e) => {
