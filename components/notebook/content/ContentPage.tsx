...
import { EducationPage } from "../split/EducationPage";
import { ExperiencePage } from "../split/ExperiencePage";
import { HackathonsPage } from "../split/HackathonsPage";
import { LeadershipPage } from "../split/LeadershipPage";
...
function ContentBody({
  ...
  if (kind === "education")
    return <EducationPage onClose={onClose} animate={animate} sessionKey={sessionKey} />;
  if (kind === "projects")
    return <ProjectsPage onClose={onClose} animate={animate} sessionKey={sessionKey} />;
  if (kind === "hackathons")
    return (
      <HackathonsPage onClose={onClose} animate={animate} sessionKey={sessionKey} />
    );
  if (kind === "leadership")
    return <LeadershipPage onClose={onClose} animate={animate} sessionKey={sessionKey} />;
  if (kind === "linkedin")
