              ...
              {hackathons.map((hackathon, index) => (
                <div key={index} className="relative">
                  ...
                  <div className="pl-10 sm:pl-12 md:pl-14">
                    <p className="text-sm md:text-base text-brown-700 leading-relaxed mb-2">{hackathon.description}</p>
                    {'achievement' in hackathon && hackathon.achievement && (
                      <p className="text-sm md:text-base text-brown-800 font-medium italic mb-3">🏆 {hackathon.achievement}</p>
                    )}
