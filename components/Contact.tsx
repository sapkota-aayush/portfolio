  ...
  return (
    <section className="py-6 md:py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-xl md:text-2xl font-bold text-brown-900 mb-2">Get In Touch</h2>
          ...
          <div className="flex flex-row justify-center gap-2 sm:gap-3 flex-wrap">
            ...
            <a
              ...
              title="LinkedIn"
              className="relative flex items-center justify-center w-10 h-10 bg-brown-200 text-brown-900 rounded hover:bg-brown-300 transition-colors group"
            >
