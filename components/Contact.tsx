        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 flex-wrap">
            <a
              ...
              download
              className="flex items-center justify-center gap-2 px-5 py-3 min-h-[44px] bg-brown-600 text-white rounded hover:bg-brown-700 transition-colors text-sm md:text-base"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 px-5 py-3 min-h-[44px] bg-brown-200 text-brown-900 rounded hover:bg-brown-300 transition-colors text-sm md:text-base"
            >
