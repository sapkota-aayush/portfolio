...
const OLLAMA_TOOLS = [
  {
    ...
    function: {
      name: "showAbout",
      description:
        "Display Aayush's personal About page. Call for open-ended 'tell me about yourself' / 'who are you' / 'what's your story' style questions, or when the user explicitly asks for /about.",
  ...
  },
  {
    ...
    function: {
      name: "showEducation",
      description:
        "Display Aayush's education page. Call when the user asks about school, college, St. Lawrence College, degree, diploma, studies, or graduation.",
      parameters: { type: "object", properties: {}, required: [] },
    },
  },
  {
    ...
    function: {
      name: "showProjects",
      description:
        "Display Aayush's projects page. Call when the user asks about projects, builds, apps, Vojur, Pinpoint, EarthPulse, Numaflow, open source, NFC cards, SLC Indoor Navigation, Dumps.online, or Folderly.",
      parameters: { type: "object", properties: {}, required: [] },
    },
  },
  {
    ...
    function: {
      name: "showHackathons",
      description:
        "Display Aayush's hackathons page. Call when the user asks about hackathons, QHacks, King's Hack, McHacks, Stupid Hackathon, NGMI, RedFlagr, or hackathon builds.",
      parameters: { type: "object", properties: {}, required: [] },
    },
  },
  {
  ...
  },
  {
    ...
    function: {
      name: "showLinkedIn",
      description:
        "Display a stacked-deck carousel of Aayush's project and community highlights. Call when the user asks about LinkedIn, highlights, projects, posts, or public work.",
      parameters: { type: "object", properties: {}, required: [] },
    },
  },
];
